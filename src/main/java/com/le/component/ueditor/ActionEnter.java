...
import com.le.component.ueditor.hunter.FileManager;
import com.le.component.ueditor.hunter.ImageHunter;
import com.le.component.ueditor.upload.Uploader;
    ...
    public String invoke() {
        ...
        switch (actionCode) {
            ...
            case ActionMap.CONFIG:
                Map<String, Object> allConfig = this.configManager.getAllConfig();
