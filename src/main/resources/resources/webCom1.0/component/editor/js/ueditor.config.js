...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL = window.realPath+'/component/editor/utf8-jsp/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: window.base + "/admin/component/ueditor/config"
    ...
    //	        	return System.base+'/admin/file/ueOssUpload.jhtml';
    //	        }else if (action == 'catchimage'){
    //	        	//抓取图片，不知道为什么 图片的路径没传过去，无法抓取。
    //	        	return System.base+'/admin/file/ueCatchUpload.jhtml';
    //	        	//	        } else {
